...
| `iot.device:manage` | 注册/删除/分组 |
| `iot.device:control` | 下发指令 |
| `iot.rule:edit` | 规则编排 |
| `iot.tenant:manage` | 租户管理 |
| `iot.template:publish` | 模板市场上架 |
| `iot.ai:subscribe` | 订阅 DoerFlow AI 服务 |
| `iot.chain:earn` | 设备链上收益配置 |
